...
import { ArrowLeft, MapPin, Calendar, Layers, ArrowUpRight } from 'lucide-react'
        ...
        <div className="container-x">
          ...
          <dl className="mt-10 flex flex-wrap gap-x-12 gap-y-6 border-y border-mist py-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <dt className="text-xs uppercase tracking-[0.18em] text-primary-500">Categorie</dt>
                <dd className="mt-0.5 font-display text-lg font-semibold capitalize">{project.category}</dd>
              </div>
            </div>
          </dl>
        </div>
