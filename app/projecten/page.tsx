...
export const metadata: Metadata = {
  title: 'Projecten · recente klussen',
  description: 'Recente keukens, verbouwingen, timmerwerk en sanitair-klussen in West-Brabant. Bekijk wat Marts Montage Service recent heeft opgeleverd.',
}
        ...
        <div className="container-x">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-lg text-primary-600 max-w-xl leading-relaxed">
              Een selectie van recent opgeleverde klussen in West-Brabant. Keukens, verbouwingen, timmerwerk en sanitair.
            </p>
          </div>
        </div>
      </section>
