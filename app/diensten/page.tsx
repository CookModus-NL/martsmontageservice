...
export const metadata: Metadata = {
  title: 'Diensten · Keuken, verbouwing, timmerwerk, sanitair',
  description: 'Keuken plaatsen, verbouwingen, timmerwerk, sanitair, schilderwerk en alle klussen daartussenin. Marts Montage Service uit Langeweg, voor heel West-Brabant.',
}
        ...
        <div className="container-x">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 font-display text-5xl font-bold tracking-tight text-primary-900 sm:text-6xl lg:text-7xl leading-[1.02]">
              Eén vakman,<br/>
              <span className="italic font-light text-primary-600">alle klussen.</span>
            </h1>
            <p className="mt-8 text-lg text-primary-600 max-w-xl leading-relaxed">
              Zes specialismen. Van complete verbouwing tot een losse klus. Eén aanspreekpunt van begin tot oplevering.
            </p>
          </div>
        </div>
      </section>
