...
export const metadata: Metadata = {
  ...
  description: 'Hoe Marts Montage Service omgaat met jouw persoonsgegevens.',
}
    ...
    <section className="bg-paper py-16 lg:py-24">
      <article className="container-tight">
        ...
        <div className="mt-12 space-y-8 text-primary-700 leading-relaxed">
          <p>
            Ik, Mart van {business.legalName} (KvK {business.kvk}), respecteer je privacy en verwerk persoonsgegevens alleen volgens de AVG. Op deze pagina lees je welke gegevens ik verzamel, waarom en hoe lang.
          </p>
