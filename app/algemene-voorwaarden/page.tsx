...
export const metadata: Metadata = {
  ...
  description: 'Algemene voorwaarden van Marts Montage Service, gevestigd te Langeweg.',
}
        ...
        <div className="mt-12 space-y-10 text-primary-700 leading-relaxed">
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li><strong>Marts Montage Service</strong>: de onderneming gevestigd te Langeweg, ingeschreven bij de Kamer van Koophandel onder nummer {business.kvk}.</li>
              <li><strong>Opdrachtgever</strong>: iedere natuurlijke persoon of rechtspersoon die werkzaamheden laat uitvoeren door Marts Montage Service.</li>
              <li><strong>Werkzaamheden</strong>: alle overeengekomen montage-, timmer-, sanitair-, klus-, schilder-, verbouwings- en aanverwante werkzaamheden.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Deze algemene voorwaarden zijn van toepassing op alle offertes, overeenkomsten, werkzaamheden, leveringen en diensten van Marts Montage Service.</li>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              ...
              <li>Kennelijke fouten of vergissingen in offertes binden Marts Montage Service niet.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Marts Montage Service reserveert tijd, capaciteit en planning specifiek voor opdrachtgever.</li>
              ...
              <li>Indien werkzaamheden niet kunnen starten of doorgaan door omstandigheden aan de zijde van opdrachtgever, heeft Marts Montage Service het recht een vergoeding in rekening te brengen wegens gereserveerde capaciteit, personeelskosten, omzetverlies, voorrijkosten en niet-opvulbare planningsruimte.</li>
              <li>
              ...
              <li>Bij annulering of verplaatsing binnen 5 werkdagen voor aanvang van de werkzaamheden behoudt Marts Montage Service zich het recht voor een vergoeding in rekening te brengen.</li>
              <li>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>
                ...
                <ul className="mt-2 space-y-1 list-disc pl-5">
                  ...
                  <li>ondergronden en aansluitpunten geschikt en gereed zijn.</li>
                </ul>
              </li>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Marts Montage Service voert werkzaamheden uit naar beste inzicht, vakmanschap en professionele normen.</li>
              ...
              <li>Marts Montage Service heeft het recht werkzaamheden geheel of gedeeltelijk door derden te laten uitvoeren.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              ...
              <li>Marts Montage Service heeft het recht een aanbetaling te verlangen.</li>
              ...
              <li>Marts Montage Service heeft het recht werkzaamheden op te schorten totdat volledige betaling heeft plaatsgevonden.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Werkzaamheden gelden als opgeleverd zodra opdrachtgever het werk in gebruik neemt, akkoord geeft of Marts Montage Service redelijkerwijs heeft aangegeven dat het werk gereed is.</li>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Marts Montage Service is uitsluitend aansprakelijk voor directe schade veroorzaakt door aantoonbare opzet of grove nalatigheid.</li>
              <li>Aansprakelijkheid is beperkt tot het factuurbedrag van de betreffende werkzaamheden.</li>
              <li>
                Marts Montage Service is niet aansprakelijk voor:
                <ul className="mt-2 space-y-1 list-disc pl-5">
                  <li>gevolgschade en indirecte schade;</li>
                  <li>vertragingen door derden;</li>
                  <li>werking van ondergronden en materialen;</li>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Marts Montage Service is niet aansprakelijk voor vertragingen of tekortkomingen als gevolg van overmacht.</li>
              <li>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              ...
              <li>Op installatie- en montagewerk wordt 1 jaar garantie verleend op de werkzaamheden. Voor materialen geldt de fabrieksgarantie van de leverancier.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              <li>Alle geleverde materialen blijven eigendom van Marts Montage Service totdat volledige betaling heeft plaatsgevonden.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="mt-4 space-y-2 list-decimal pl-5">
              ...
              <li>Geschillen worden voorgelegd aan de bevoegde rechter in het arrondissement waarin Marts Montage Service gevestigd is.</li>
            </ol>
          </section>
        </div>
      </article>
