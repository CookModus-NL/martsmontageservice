...
export const metadata: Metadata = {
  ...
  description: 'Stuur Mart van Marts Montage Service een WhatsApp met je klusvraag of foto’s. Binnen 1 werkdag een eerste indicatie. Of bel direct ' + business.phone + '.',
}
        ...
        <div className="container-x">
          <div className="max-w-3xl reveal">
            ...
            <h1 className="mt-6 font-display text-5xl font-bold tracking-tight text-primary-900 sm:text-6xl lg:text-7xl leading-[1.02]">
              Stuur me een<br/>
              <span className="italic font-light text-primary-600">appje.</span>
            </h1>
            <p className="mt-8 text-lg text-primary-600 max-w-xl leading-relaxed">
              Snelste route: WhatsApp met een korte beschrijving en eventueel foto’s. Binnen 1 werkdag weet je of ik kan en wat het globaal kost.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="relative grid gap-8 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8 text-white">
                ...
                <ul className="mt-8 grid gap-3 text-base text-white/95 sm:grid-cols-2">
                  <li className="flex items-start gap-2"><Camera className="h-5 w-5 mt-0.5 shrink-0" /> Stuur foto’s van de klus</li>
        ...
        <div className="container-x">
          <div className="max-w-2xl mb-12">
            ...
            <h2 className="mt-4 font-display text-4xl font-bold text-primary-900 sm:text-5xl">
              Geen formulieren,<br/>
              <span className="italic font-light text-primary-600">geen wachten.</span>
            </h2>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              {
                num: '01',
                title: 'Beschrijf de klus',
                body: 'Een paar zinnen en wat foto’s zijn vaak genoeg om te weten of we passen op die klus.',
              },
              {
                num: '02',
                title: 'Reactie dezelfde dag',
                body: 'Doordeweeks meestal binnen een paar uur. Uiterlijk de volgende werkdag krijg je een indicatie.',
              },
              {
                num: '03',
                title: 'Vrijblijvend kijken',
                body: 'Bij grotere klussen kom ik langs om te kijken, te meten en de offerte uit te werken. Geen verplichtingen.',
              },
            ].map((s) => (
          ...
          <div className="grid gap-12 lg:grid-cols-12">
            <div className="lg:col-span-5">
              ...
              <h2 className="mt-4 font-display text-3xl font-bold text-primary-900 sm:text-4xl">
                Marts Montage Service
              </h2>
              <p className="mt-6 text-primary-600 leading-relaxed">
                All-round klusbedrijf uit Langeweg. Sinds {business.founded.split('-')[0]} actief voor particulieren in West-Brabant. Eén vakman, één aanspreekpunt.
              </p>
            </div>
